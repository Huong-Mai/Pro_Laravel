<div id="header">
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="{{route('trang-chu')}}" id="logo"><img src="source/image/logo_hcn.png" width="200px" alt=""></a>
				</div>
                                ...
                                <div class="cart-item">
                                    ...
                                    <a class="pull-left" href="#"><img src="source/image/product/" alt=""></a>
										<div class="media-body">
											<span class="cart-item-title">$product->TenSP</span>
					...
					<ul class="l-inline ov">
						...
						<li><a href="#">Sản phẩm</a>
							<ul class="sub-menu">
								...
								<li><a href="{{route('loai-sp',$lsp->TenLoai)}}">{{$lsp->TenLoai}}</a></li>
								@endforeach
							</ul>
						</li>
